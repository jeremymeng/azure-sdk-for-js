...
# This script processes the first 5 package names from wrong-version.txt
# for testing purposes

# Extract just the package names from wrong-version.txt
echo "Extracting first 5 package names from wrong-version.txt for testing..."
cut -d':' -f1 wrong-version.txt | head -n 5 > test-package-names.txt
