...
- Fix tracing to set correct span attributes ([PR link](https://github.com/Azure/azure-sdk-for-js/pull/6565)).
- Update dependency `@azure/core-tracing` version to `1.0.0-preview.8`.
