...
import { type MsalPersistenceOptions, msalPersistencePlatforms } from "./platforms";
import { type IPersistence as Persistence, PersistenceCachePlugin } from "@azure/msal-node-extensions";
