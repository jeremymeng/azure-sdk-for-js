...
export class PageBlob {
  ...
  constructor(
    ...
    const userAgentPrefix = prefixFromOptions
      ...
      : `azsdk-js-client`;
    this._client = createPageBlob(endpointParam, credential, containerName, blobName, {
      ...options,
  ...
  resize(
    ...
    return resize(this._client, blobContentLength, options);
  }
  ...
  create(
    ...
    return create(this._client, blobContentLength, options);
  }
}
