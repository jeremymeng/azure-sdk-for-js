...
import {
  ...
  storageServicePropertiesSerializer,
  storageServicePropertiesDeserializer,
  storageErrorDeserializer,
  StorageServiceStats,
  storageServiceStatsDeserializer,
  _ListContainersSegmentResponse,
  _listContainersSegmentResponseDeserializer,
  ContainerItem,
  KeyInfo,
  keyInfoSerializer,
  UserDelegationKey,
  userDelegationKeyDeserializer,
...
export async function _filterBlobsDeserialize(
  ...
  return filterBlobSegmentDeserializer(result.body);
}
...
export async function _getUserDelegationKeyDeserialize(
  ...
  return userDelegationKeyDeserializer(result.body);
}
...
export async function _listContainersSegmentDeserialize(
  ...
  return _listContainersSegmentResponseDeserializer(result.body);
}
...
export async function _getStatisticsDeserialize(
  ...
  return storageServiceStatsDeserializer(result.body);
}
...
export async function _getPropertiesDeserialize(
  ...
  return storageServicePropertiesDeserializer(result.body);
}
