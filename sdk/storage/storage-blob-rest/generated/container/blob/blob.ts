...
import { PageBlob, PageBlobOptionalParams } from "./pageBlob/pageBlob.js";
import { AppendBlob, AppendBlobOptionalParams } from "./appendBlob/appendBlob.js";
import { BlockBlob, BlockBlobOptionalParams } from "./blockBlob/blockBlob.js";
...
export class Blob {
  ...
  constructor(
    ...
    const userAgentPrefix = prefixFromOptions
      ...
      : `azsdk-js-client`;
    this._client = createBlob(endpointParam, credential, containerName, blobName, {
      ...options,
      userAgentOptions: { userAgentPrefix },
    });
    this.pipeline = this._client.pipeline;
    this._clientParams = { endpointParam, credential, containerName, blobName, options };
  }
  ...
  setImmutabilityPolicy(
    ...
    return setImmutabilityPolicy(this._client, options);
  }
  ...
  getPageBlob(options: PageBlobOptionalParams = {}): PageBlob {
    return new PageBlob(
      this._clientParams.endpointParam,
      this._clientParams.credential,
      this._clientParams.containerName,
      this._clientParams.blobName,

      { ...this._clientParams.options, ...options },
    );
  }

  getAppendBlob(options: AppendBlobOptionalParams = {}): AppendBlob {
  ...
  getBlockBlob(options: BlockBlobOptionalParams = {}): BlockBlob {
