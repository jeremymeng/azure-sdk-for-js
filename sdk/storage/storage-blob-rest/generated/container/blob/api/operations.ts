...
export function _setTagsSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=tags{?timeout,versionid}",
    {
...
export function _getTagsSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=tags{?timeout,snapshot,versionid}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export async function _getTagsDeserialize(result: PathUncheckedResponse): Promise<BlobTags> {
  ...
  return blobTagsDeserializer(result.body);
}
...
export function _getAccountInfoSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?restype=account&comp=properties&blob{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _setTierSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=tier{?snapshot,versionid,timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      snapshot: options?.snapshot,
...
export function _abortCopyFromUrlSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=copy&copyid{?timeout,copyid}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _copyFromUrlSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=copy&sync{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _startCopyFromUrlSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _createSnapshotSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=snapshot{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _breakLeaseSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=lease&break{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _changeLeaseSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=lease&change{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _renewLeaseSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=lease&renew{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _releaseLeaseSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=lease&release{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _acquireLeaseSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=lease&acquire{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _setMetadataSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=metadata{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _setLegalHoldSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=legalhold{?timeout,snapshot,versionid}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _deleteImmutabilityPolicySend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=immutabilityPolicies{?timeout,snapshot,versionid}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export async function setImmutabilityPolicy(
  ...
  const result = await _setImmutabilityPolicySend(context, options);
...
export function _setPropertiesSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=properties&SetHTTPHeaders{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _setExpirySend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=expiry{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _undeleteSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}?comp=undelete{?timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      timeout: options?.timeout,
...
export function _$deleteSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}{?snapshot,versionid,timeout,deletetype}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      snapshot: options?.snapshot,
...
export function _getPropertiesSend(
  ...
  const path = expandUrlTemplate(
    "/{containerName}/{blobName}{?snapshot,versionid,timeout}",
    {
      containerName: context.containerName,
      blobName: context.blobName,
      snapshot: options?.snapshot,
