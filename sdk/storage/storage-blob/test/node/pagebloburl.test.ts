...
describe("PageBlobClient", () => {
  ...
  it("startCopyIncremental", async () => {
    ...
    let copyResponse = await destPageBlobClient.startCopyIncremental(
      Aborter.none,
      copySource
    );
    ...
    let listBlobResponse = await containerClient.listBlobFlatSegment(
      Aborter.none,
      undefined,
      {
    ...
    copyResponse = await destPageBlobClient.startCopyIncremental(
      Aborter.none,
      copySource
    );
    ...
    listBlobResponse = await containerClient.listBlobFlatSegment(
      Aborter.none,
      undefined,
      {
        include: ["copy", "snapshots"]
