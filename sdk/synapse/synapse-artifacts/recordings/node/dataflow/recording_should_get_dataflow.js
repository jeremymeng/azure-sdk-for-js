...
nock("https://login.microsoftonline.com:443", { encodedQueryParams: true })
  .post(
    ...
    "response_type=token&grant_type=client_credentials&client_id=azure_client_id&client_secret=azure_client_secret&scope=https%3A%2F%2Fsanitized%2F"
  )
  .reply(
    200,
    {
...
nock("https://testaccount.dev.azuresynapse.net", { encodedQueryParams: true })
  ...
  .reply(
    200,
    {
      ...
      etag: "aa0690f6-0000-0800-0000-606b80b20000"
    },
    [
      "Cache-Control",
      "no-cache",
