...
describe("urlHelpers", () => {
  ...
  describe("githubIssueLinkUrl", () => {
    it("should return the correct GitHub issue link URL", () => {
      ...
      const expectedUrl = `https://github.com/Azure/azure-sdk-for-js/issues?q=is%3Aopen+is%3Aissue+label%3Acustomer-reported+label%3AClient+-label%3Aissue-addressed+-label%3Aquestion+-label%3Aneeds-author-feedback+-label%3Afeature-request+label%3A%22${label.replace(" ", "+")}%22+created%3A%22${created}%22`;
